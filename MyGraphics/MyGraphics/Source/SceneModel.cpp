...
void SceneModel::Init()
{
	...
	meshList[GEO_MODEL1] = MeshBuilder::GenerateOBJ("MODEL1", "OBJ//hi.obj");
	...
	meshList[GEO_BACK] = MeshBuilder::GenerateQuad("FRONT", Color(0, 0, 0));
	meshList[GEO_BACK]->textureID = LoadTGA("Image//back.tga");
	meshList[GEO_TOP] = MeshBuilder::GenerateQuad("FRONT", Color(0, 0, 0));
	meshList[GEO_TOP]->textureID = LoadTGA("Image//top.tga");
	meshList[GEO_BOTTOM] = MeshBuilder::GenerateQuad("FRONT", Color(0, 0, 0));
	meshList[GEO_BOTTOM]->textureID = LoadTGA("Image//bottom.tga");
	meshList[GEO_RIGHT] = MeshBuilder::GenerateQuad("FRONT", Color(0, 0, 0));
	meshList[GEO_RIGHT]->textureID = LoadTGA("Image//right.tga");
	meshList[GEO_LEFT] = MeshBuilder::GenerateQuad("FRONT", Color(0, 0, 0));
