...
void SceneLight2::Init()
{
	...
	meshList[GEO_CYLIN] = MeshBuilder::GenerateCylin("CYLINDER", Color(0, 1, 1), 36);
	meshList[GEO_CYLIN]->material.kAmbient.Set(0.1f, 0.1f, 0.1f);
	meshList[GEO_CYLIN]->material.kDiffuse.Set(0.6f, 0.6f, 0.6f);
	meshList[GEO_CYLIN]->material.kSpecular.Set(0.3f, 0.3f, 0.3f);
	meshList[GEO_CYLIN]->material.kShininess = 1.f;

	meshList[GEO_CONE] = MeshBuilder::GenerateCone("CYLINDER", Color(0, 1, 1), 36);
	meshList[GEO_CONE]->material.kAmbient.Set(0.1f, 0.1f, 0.1f);
	...
	meshList[GEO_QUAD] = MeshBuilder::GenerateQuad("FLOOR", Color(0, 1, 0));
...
void SceneLight2::Render()
{
	...
	modelStack.Translate(0, 1, 0);
	//RenderMesh(meshList[GEO_CYLIN], true);
	modelStack.PopMatrix();
