...
void Scene3::Init()
{
	...
	meshList[GEO_HEMI] = MeshBuilder::GenerateHemi("HEMI", Color(1, 1, 0), 18, 36);
	//meshList[GEO_CYLIN] = MeshBuilder::GenerateCylin("CYLIN", Color(1, 0, 1), 18, 36);
}
...
void Scene3::Render()
{
	...
	translate.SetToTranslation(-1, 2, 1);
	...
	translate.SetToTranslation(3, 2, 1);
	rotate.SetToRotation(rotateAngle, 0, 0, 1);
